...
public class Main {
    ...
    Main() {
        ...
        if (a) {
            ...
            for (int i = 1; i <= 10; i++) {
                for (int j = 1; j <= 10; j++) {
                    for (int k = 1; k <= 10; k++) {
                        ...
                        SalonSimulation salonSimulation = new SalonSimulation((17 - 9) * 3600, i, j, k, this);
                        salonSimulation.simulate(1000);
            ...
            SalonSimulation salonSimulation = new SalonSimulation((17 - 9) * 3600, 2, 6, 5, this);
